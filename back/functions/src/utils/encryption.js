...
const ENCRYPTION_KEY = process.env.ENCRYPTION_KEY || 'a_very_secret_key_of_at_least_32_chars'; // Must be 32 bytes (256 bits)

if (ENCRYPTION_KEY.length !== 32) {
    console.warn("WARNING: ENCRYPTION_KEY is not 32 bytes long. Please generate a secure 32-byte key.");
}
